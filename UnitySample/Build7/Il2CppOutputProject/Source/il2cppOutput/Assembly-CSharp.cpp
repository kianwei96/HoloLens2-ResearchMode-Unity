...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ResearchModeVideoStream_LateUpdate_m498E9DAF113696E77CA334B43209342893664AD7 (ResearchModeVideoStream_t07A236CED0F2690ADB487B617B9A2914CE8B9C6B * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_1);
		bool L_2 = HL2ResearchMode_DepthMapTextureUpdated_m9CA1B1922F4D090EE27341326AA1E2ACC117D236(L_1, /*hidden argument*/NULL);
		if (!L_2)
		{
			goto IL_0068;
		}
	}
	{
		...
		NullCheck(L_3);
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_4 = HL2ResearchMode_GetDepthMapTextureBuffer_mC032E331906CCCAA5C35256AE93CA5CF5005B0F2(L_3, /*hidden argument*/NULL);
		V_0 = L_4;
	...
	}
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_6 = __this->get_depthFrameData_9();
		if (L_6)
		{
			goto IL_0036;
		}
	}
	{
		...
		__this->set_depthFrameData_9(L_7);
		// }
		goto IL_004c;
	}
...
IL_0036:
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_9 = __this->get_depthFrameData_9();
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_10 = __this->get_depthFrameData_9();
		NullCheck(L_10);
		Buffer_BlockCopy_m1F882D595976063718AF6E405664FC761924D353((RuntimeArray *)(RuntimeArray *)L_8, 0, (RuntimeArray *)(RuntimeArray *)L_9, 0, (((int32_t)((int32_t)(((RuntimeArray*)L_10)->max_length)))), /*hidden argument*/NULL);
	}

IL_004c:
	{
		// depthMediaTexture.LoadRawTextureData(depthFrameData);
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_11 = __this->get_depthMediaTexture_8();
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_12 = __this->get_depthFrameData_9();
		NullCheck(L_11);
		Texture2D_LoadRawTextureData_m0331275D060EC3521BCCF84194FA35BBEEF767CB(L_11, L_12, /*hidden argument*/NULL);
		// depthMediaTexture.Apply();
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_13 = __this->get_depthMediaTexture_8();
		NullCheck(L_13);
...
IL_0068:
	{
		...
		bool L_14 = __this->get_startRealtimePreview_30();
		if (!L_14)
		{
			goto IL_00d0;
		}
	}
	{
		...
		NullCheck(L_15);
		bool L_16 = HL2ResearchMode_ShortAbImageTextureUpdated_m17F79A4600FCA7C46A731ADF7465608B9A63C37C(L_15, /*hidden argument*/NULL);
		if (!L_16)
		{
			goto IL_00d0;
		}
	}
	{
		...
		HL2ResearchMode_t796C56828D4919F35688AA2A873368FF2F009360 * L_17 = __this->get_researchMode_4();
		NullCheck(L_17);
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_18 = HL2ResearchMode_GetShortAbImageTextureBuffer_m7BEE1C285E3AEA467271325CE0A6EF4A3EF3178D(L_17, /*hidden argument*/NULL);
		V_1 = L_18;
		// if (frameTexture.Length > 0)
	...
	}
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_20 = __this->get_shortAbImageFrameData_13();
		if (L_20)
		{
			goto IL_009e;
		}
	}
	{
		...
		__this->set_shortAbImageFrameData_13(L_21);
		// }
		goto IL_00b4;
	}
...
IL_009e:
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_24 = __this->get_shortAbImageFrameData_13();
		NullCheck(L_24);
		Buffer_BlockCopy_m1F882D595976063718AF6E405664FC761924D353((RuntimeArray *)(RuntimeArray *)L_22, 0, (RuntimeArray *)(RuntimeArray *)L_23, 0, (((int32_t)((int32_t)(((RuntimeArray*)L_24)->max_length)))), /*hidden argument*/NULL);
	}

IL_00b4:
	{
		// shortAbImageMediaTexture.LoadRawTextureData(shortAbImageFrameData);
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_25 = __this->get_shortAbImageMediaTexture_12();
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_26 = __this->get_shortAbImageFrameData_13();
		NullCheck(L_25);
		Texture2D_LoadRawTextureData_m0331275D060EC3521BCCF84194FA35BBEEF767CB(L_25, L_26, /*hidden argument*/NULL);
		// shortAbImageMediaTexture.Apply();
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_27 = __this->get_shortAbImageMediaTexture_12();
		NullCheck(L_27);
...
IL_00d0:
	{
		...
		bool L_28 = __this->get_startRealtimePreview_30();
		if (!L_28)
		{
			goto IL_0138;
		}
	}
	{
		...
		NullCheck(L_29);
		bool L_30 = HL2ResearchMode_LFImageUpdated_mDA3C62DD044CA744D8B7510B45C7F318CECB83F7(L_29, /*hidden argument*/NULL);
		if (!L_30)
		{
			goto IL_0138;
		}
	}
	{
		...
		NullCheck(L_31);
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_32 = HL2ResearchMode_GetLFCameraBuffer_m6B5569773B2F4DF330C5ED70DA79AC81387A5810(L_31, /*hidden argument*/NULL);
		V_2 = L_32;
		// if (frameTexture.Length > 0)
	...
	{
		// if (LFFrameData == null)
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_34 = __this->get_LFFrameData_21();
		if (L_34)
		{
			goto IL_0106;
		}
	}
	{
		...
		__this->set_LFFrameData_21(L_35);
		// }
		goto IL_011c;
	}
...
IL_0106:
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_38 = __this->get_LFFrameData_21();
		NullCheck(L_38);
		Buffer_BlockCopy_m1F882D595976063718AF6E405664FC761924D353((RuntimeArray *)(RuntimeArray *)L_36, 0, (RuntimeArray *)(RuntimeArray *)L_37, 0, (((int32_t)((int32_t)(((RuntimeArray*)L_38)->max_length)))), /*hidden argument*/NULL);
	}

IL_011c:
	{
		// LFMediaTexture.LoadRawTextureData(LFFrameData);
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_39 = __this->get_LFMediaTexture_20();
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_40 = __this->get_LFFrameData_21();
		NullCheck(L_39);
		Texture2D_LoadRawTextureData_m0331275D060EC3521BCCF84194FA35BBEEF767CB(L_39, L_40, /*hidden argument*/NULL);
		// LFMediaTexture.Apply();
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_41 = __this->get_LFMediaTexture_20();
		NullCheck(L_41);
...
IL_0138:
	{
		...
		bool L_42 = __this->get_startRealtimePreview_30();
		if (!L_42)
		{
			goto IL_01a0;
		}
	}
	{
		...
		NullCheck(L_43);
		bool L_44 = HL2ResearchMode_RFImageUpdated_m2F07A8FF7D9059C133411CD29D53CBE155C821B9(L_43, /*hidden argument*/NULL);
		if (!L_44)
		{
			goto IL_01a0;
		}
	}
	{
		...
		HL2ResearchMode_t796C56828D4919F35688AA2A873368FF2F009360 * L_45 = __this->get_researchMode_4();
		NullCheck(L_45);
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_46 = HL2ResearchMode_GetRFCameraBuffer_mB542778AFD0D8F00EA6421A1F803B489109640EC(L_45, /*hidden argument*/NULL);
		V_3 = L_46;
		// if (frameTexture.Length > 0)
	...
	{
		// if (RFFrameData == null)
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_48 = __this->get_RFFrameData_25();
		if (L_48)
		{
			goto IL_016e;
		}
	}
	{
		...
		__this->set_RFFrameData_25(L_49);
		// }
		goto IL_0184;
	}
...
IL_016e:
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_52 = __this->get_RFFrameData_25();
		NullCheck(L_52);
		Buffer_BlockCopy_m1F882D595976063718AF6E405664FC761924D353((RuntimeArray *)(RuntimeArray *)L_50, 0, (RuntimeArray *)(RuntimeArray *)L_51, 0, (((int32_t)((int32_t)(((RuntimeArray*)L_52)->max_length)))), /*hidden argument*/NULL);
	}

IL_0184:
	{
		// RFMediaTexture.LoadRawTextureData(RFFrameData);
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_53 = __this->get_RFMediaTexture_24();
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_54 = __this->get_RFFrameData_25();
		NullCheck(L_53);
		Texture2D_LoadRawTextureData_m0331275D060EC3521BCCF84194FA35BBEEF767CB(L_53, L_54, /*hidden argument*/NULL);
		// RFMediaTexture.Apply();
		Texture2D_tBBF96AC337723E2EF156DF17E09D4379FD05DE1C * L_55 = __this->get_RFMediaTexture_24();
		NullCheck(L_55);
...
IL_01a0:
	{
		// if (renderPointCloud)
		bool L_56 = __this->get_renderPointCloud_31();
		if (!L_56)
		{
			goto IL_0216;
		}
	}
	{
		...
		NullCheck(L_57);
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_58 = HL2ResearchMode_GetPointCloudBuffer_mE9725CF550FAEFFCCDA0D2D10B889D505615C50A(L_57, /*hidden argument*/NULL);
		V_4 = L_58;
		// if (pointCloud.Length > 0)
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_59 = V_4;
		NullCheck(L_59);
	...
	}
	{
		...
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_60 = V_4;
		NullCheck(L_60);
		V_5 = ((int32_t)((int32_t)(((int32_t)((int32_t)(((RuntimeArray*)L_60)->max_length))))/(int32_t)3));
		// Vector3[] pointCloudVector3 = new Vector3[pointCloudLength];
		int32_t L_61 = V_5;
		Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28* L_62 = (Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28*)(Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28*)SZArrayNew(Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28_il2cpp_TypeInfo_var, (uint32_t)L_61);
		V_6 = L_62;
...
IL_01d0:
	{
		...
		Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28* L_63 = V_6;
		int32_t L_64 = V_7;
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_65 = V_4;
		int32_t L_66 = V_7;
		NullCheck(L_65);
		int32_t L_67 = ((int32_t)il2cpp_codegen_multiply((int32_t)3, (int32_t)L_66));
		float L_68 = (L_65)->GetAt(static_cast<il2cpp_array_size_t>(L_67));
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_69 = V_4;
		int32_t L_70 = V_7;
		NullCheck(L_69);
		int32_t L_71 = ((int32_t)il2cpp_codegen_add((int32_t)((int32_t)il2cpp_codegen_multiply((int32_t)3, (int32_t)L_70)), (int32_t)1));
		float L_72 = (L_69)->GetAt(static_cast<il2cpp_array_size_t>(L_71));
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_73 = V_4;
		int32_t L_74 = V_7;
		NullCheck(L_73);
		int32_t L_75 = ((int32_t)il2cpp_codegen_add((int32_t)((int32_t)il2cpp_codegen_multiply((int32_t)3, (int32_t)L_74)), (int32_t)2));
		...
		NullCheck(L_63);
		(L_63)->SetAt(static_cast<il2cpp_array_size_t>(L_64), (Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720 )L_77);
		// for (int i = 0; i < pointCloudLength; i++)
		int32_t L_78 = V_7;
...
IL_01fd:
	...
	}
	{
		...
		PointCloudRenderer_tCE52A4117921C8A9BDC55E76A7B2F4E01FE2FC15 * L_81 = __this->get_pointCloudRenderer_28();
		Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28* L_82 = V_6;
		Color_t119BCA590009762C7223FDD3AF9706653AC84ED2  L_83 = __this->get_pointColor_27();
		NullCheck(L_81);
		PointCloudRenderer_Render_mD4CC932CD35EA95B495BEBFE1B1E23BDCA10AA01(L_81, L_82, L_83, /*hidden argument*/NULL);
	}
