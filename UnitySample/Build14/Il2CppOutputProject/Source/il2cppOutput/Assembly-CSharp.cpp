...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ResearchModeVideoStream_LateUpdate_m498E9DAF113696E77CA334B43209342893664AD7 (ResearchModeVideoStream_t07A236CED0F2690ADB487B617B9A2914CE8B9C6B * __this, const RuntimeMethod* method)
{
	...
	int32_t V_9 = 0;
	{
		...
		NullCheck(L_0);
		String_t* L_1 = HL2ResearchMode_GetTimestampTest_mBC776D818802E7C71FD02C97FDF8934F953AC30A(L_0, /*hidden argument*/NULL);
		NullCheck(L_1);
...
IL_0196:
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_56 = V_4;
...
IL_01c9:
	...
	}
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_69 = V_5;
...
IL_0202:
	{
		...
		ByteU5BU5D_tD06FDBE8142446525DF1C40351D523A228373821* L_70 = V_5;
...
IL_0235:
	...
	}
	{
		...
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_79 = V_6;
		NullCheck(L_79);
	...
	}
	{
		...
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_80 = V_6;
		NullCheck(L_80);
		V_7 = ((int32_t)((int32_t)(((int32_t)((int32_t)(((RuntimeArray*)L_80)->max_length))))/(int32_t)3));
...
IL_0265:
	{
		...
		Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28* L_83 = V_8;
		int32_t L_84 = V_9;
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_85 = V_6;
		int32_t L_86 = V_9;
		NullCheck(L_85);
		...
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_89 = V_6;
		int32_t L_90 = V_9;
		NullCheck(L_89);
		...
		SingleU5BU5D_tA7139B7CAA40EAEF9178E2C386C8A5993754FDD5* L_93 = V_6;
		int32_t L_94 = V_9;
		NullCheck(L_93);
		...
		// for (int i = 0; i < pointCloudLength; i++)
		int32_t L_98 = V_9;
		V_9 = ((int32_t)il2cpp_codegen_add((int32_t)L_98, (int32_t)1));
	}
...
IL_0292:
	...
	}
	{
		...
		Vector3U5BU5D_tB9EC3346CC4A0EA5447D968E84A9AC1F6F372C28* L_102 = V_8;
